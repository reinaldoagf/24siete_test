...
export default function Header() {
    return (
      <div className="flex flex-wrap p-3 items-center sticky top-0 bg-zinc-200 h-fit  md:h-16 z-30">
        <div className="flex items-center grow md:grow-0 w-fit md:w-48">
          ...
          <div className="ml-2 font-bold text-xl">24Siete test</div>
        </div>
        ...
        <div className="flex items-center order-2 md:order-3 pl-0 md:pl-3">
          <div className="relative">
            ...
            <div className="absolute right-0 top-0 w-3 h-3 bg-zinc-200 rounded-full p-0.5">
        ...
        <div className="flex  mt-4 md:mt-0 order-3 md:order-2 w-full grow md:w-fit ">
          <button className="w-10 h-10 rounded-md bg-zinc-300 grid place-items-center mr-2 block md:hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
          ...
          <form className="relative grow md:max-w-lg">
            <input
              type="text"
              className="bg-zinc-300 pl-3 pr-10 h-10 rounded-md w-full "
              placeholder="Buscar..."
            />
